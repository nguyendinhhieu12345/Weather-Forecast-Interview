...
const WeatherCard: React.FC<IWeatherInDay> = (props) => (
    <div className="flex flex-col items-center text-center p-2 bg-white rounded-lg shadow-md">
        ...
        <div className="text-5xl my-2"><img loading='lazy' src={props?.day?.condition?.icon} alt="icon forecast" /></div>
        ...
        <div className="shadow-lg border p-8 rounded-md">
            <div className="max-w-4xl mx-auto">
                <div className="flex items-center justify-between mb-6">
                    <h1 className="text-sm xl:text-2xl font-bold">4-Day Forecast</h1>
                    <div className="flex items-center justify-center">
                        <p className="font-medium text-sm lg:text-base mr-2">
                            Choose days:
                        </p>
                        <select
                            onChange={(e) => {
