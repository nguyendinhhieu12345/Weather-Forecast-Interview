...
const WeatherSubscription: React.FC = () => {
    ...
    return (
        <div className="w-full h-[80vh] bg-[url('https://hoanghamobile.com/tin-tuc/wp-content/webp-express/webp-images/uploads/2023/08/hinh-nen-bau-troi-dem-1.jpeg.webp')] bg-no-repeat bg-cover bg-opacity-25 border shadow-lg rounded-lg px-32">
            <div className="h-full flex items-center justify-around text-white">
                <div className='flex flex-col items-center justify-center w-1/2'>
                    <img src='https://cdn.mobilecity.vn/mobilecity-vn/images/2024/05/hinh-nen-bau-troi-1.jpg.webp' alt='image sky' className='w-auto h-60 rounded-xl' />
                    ...
                    <form onSubmit={handleSubmit} className="h-full w-full">
                        <div className="flex items-center mb-4">
                            ...
                            <select
                                ...
                                className="bg-gray-50 w-auto border border-gray-300 text-gray-900 text-sm rounded-lg px-2 py-3 ml-3">
                        ...
                        {isLoading ?
                            <button className='flex items-center justify-center text-center w-full px-4 py-2 font-bold text-white bg-blue-500 rounded hover:bg-blue-700' disabled>
                                <img className="w-5 h-5 animate-spin mr-3" src="https://www.svgrepo.com/show/474682/loading.svg" alt="Loading icon" />
